...
Tags: social, icons, twitter, tinyurl, posts, page, admin, links, widgets, bitly, bit.ly, facebook, like, @anywhere,analytics

Requires at least: 3.0

Tested up to: 3.0.1

Adds Social Widgets (icons) to your blog posts. It also can update your twitter status when you publish a post and can provide analytical about your blog.
...
<h3>Key Features</h3>
<ul>
	<li>Gives you analytical data about your blog Socialness</li>
	<li>Twitter integration (Via OAuth) &#8211; It can inform your follows of your new blog posts when you publish them.</li>
...
<h3>Requirements</h3>
<ul>
	<li>PHP5 or better &#8211; PHP4 is not supported.</li>
...
<p>FAQ's can be found at: http://www.fullondesign.co.uk/socialize-this Demos can also be found at this link.</p>
== Screenshots ==

1. The Overview - Showing a few of your most Socialized pages.
...
== Changelog ==
= 2.0.5 =
* Improved icon support and CSS.
* Updated tags
* Added filters 'st-tweet-tags', 'st-tags'.
* Moved @Anywhere admin field.
* Made a few code improvements.
* Added option to disable cache
* Depreciated support for TinyURL, ur.ly, kl.am and u.nu. Also made is.gd the deafult shortner. 
* Adjusted Socialized Rank maths.
* Adjusted updateSocialized cron to run a bit more slower. 
* Improved cURL.
= 2.0.4 =
* Fixed cron issue.
* Added Cache (Improves performance)
* Added tags %date_posted% and %tags%
= 2.0.3 =
* Fixed OAuth errors.
= 2.0.2 =
* Fix correcting error while tweeting out new posts. Also added "Test Tweet" function.
= 2.0.1 =
* Fix for error during install.
= 2.0.0 =
